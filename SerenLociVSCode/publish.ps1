...
<#
.SYNOPSIS
    Build, test, package, and optionally publish the Seren Loci VS Code extension.

.DESCRIPTION
    Runs in SerenLociVSCode/ (where package.json lives).
    ...
    Steps:
      ...
      4. vsce package     - produces seren-loci-<version>.vsix
...
# -- guard: must run from SerenLociVSCode/ -----------------------------------

if (-not (Test-Path "package.json")) {
    Die "Run this script from the SerenLociVSCode/ directory (package.json not found here)."
}
